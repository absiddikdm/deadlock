	...
	<div class="container">
		...
		<div class="row align-items-center mt-5" data-aos="fade-up">
			<div class="col-lg-6 mt-5">
				<h2 class="mb-5 text-lg-2 text-white-50">Please <span class="text-white">Order</span>  Now  </h2>
			</div>
			<div class="col-lg-4 ml-auto text-right">
				<a href="https://www.fiverr.com/absiddikdm?" class="btn btn-main text-white smoth-scroll">Hire Me</a>
			</div>
		</div>
	</div>
</section>
